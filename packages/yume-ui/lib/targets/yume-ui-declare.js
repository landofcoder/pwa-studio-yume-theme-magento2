/**
 * These targets are available for interception to modules which depend on `@landofcoder/yume-ui`.
 *
 * Their implementations are found in `./yume-ui-intercept.js`.
 *
 */
module.exports = targets => {
    targets.declare({
         ...
         * targets.of('@landofcoder/yume-ui').richContentRenderers.tap(
         ...
         * const veniaTargets = targets.of('@landofcoder/yume-ui')
         ...
         * targets.of('@landofcoder/yume-ui').payments.tap(
 ...
 * import PlainHtmlRenderer from '@landofcoder/yume-ui/components/richContent/plainHtmlRenderer';
 *
