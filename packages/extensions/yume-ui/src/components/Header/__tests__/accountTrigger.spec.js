...
import AccountTrigger from '@magento/venia-ui/lib/components/accountTrigger';

jest.mock('@magento/peregrine/lib/talons/Header/useAccountTrigger', () => {
    return { useAccountTrigger: jest.fn() };
});

jest.mock('@magento/venia-ui/lib/components/AccountChip', () => 'Account Chip');
jest.mock('@magento/venia-ui/lib/components/AccountMenu', () => 'Account Menu');
